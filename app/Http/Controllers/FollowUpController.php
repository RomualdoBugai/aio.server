...
class FollowUpController extends Controller {
	...
	protected static $controller 	= 'follow_up';
	...
	protected static function form($id, $controller, $controller_id)
	{
		...
		return view('app.follow-up.form', [
	...
	public function index(Request $request, $controller, $controller_id)
	{
		...
		# check
		if ($data['status'] == true) {
			$followUps = $data['data'][$controller . "_follow_up"];
		}

		$followUps = array_reverse($followUps);

		# return view
		return view('app.follow-up.index', [
