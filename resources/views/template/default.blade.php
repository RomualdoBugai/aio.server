...
<html lang="en-US">
    ...
    <body>
        ...
        <div class="ui left vertical sidebar push menu no-border">
            ...
            <div class="ui item">
                ...
                <div class="menu">
                    ...
                    <a class="item" href="{{ route("welcome") }}" title="{{ message("template", "home") }}">
                    ...
                    <a class="item" data-tab="favorites">
                        <i class="icon-star-empty icon"></i>
                        {{ message('common', 'my-favorites') }}
                    </a>
                    ...
                    <a class="item" data-tab="quotation">
                        <i class="icon-dollar icon"></i>
                        {{ message('common', 'quotation') }}
                    </a>

                    <a class="item" href="{{ route('setup.index') }}">
        ...
        <div class="ui pusher">
            ...
            <div class="ui grid basic segment inverted blue" style="margin-top: 0; margin-bottom: 0;">
                <div class="one wide column computer two wide column tablet two wide column mobile" style="background: rgba(0,0,0,0.2) !important">
            ...
            <div class="ui tab" data-container="quotation" data-tab="quotation">


                    <div container></div>

                    <div class="ui basic segment">
                        <a class="ui basic button green" reload>
